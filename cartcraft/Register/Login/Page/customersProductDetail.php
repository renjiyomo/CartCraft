...
<p class="centered-text">₱ <?php echo number_format($product['product_price'], 2); ?></p>
            ...
            <?php if ($isOutOfStock): ?>
                ...
                <a class="button add-to-cart disabled" onclick="return false;">Add to Cart</a>
                
            <?php else: ?>
                <a href="addToCart.php?id=<?php echo $product['product_id']; ?>" class="button add-to-cart">Add to Cart</a>
                <form action="checkouts.php" method="GET">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
