...
<body>
    ...
    <?php endif; ?>
            ...
            <div class="checkout-summary">
                ...
                <form action="confirm_commission_order.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="total-box">
                        <?php 
                            $down_payment = $subtotal * 0.5;
                            $remaining_balance = $subtotal - $down_payment;
                            $final_payment_due = $remaining_balance + $shipping_fee;
                        ?>
                        ...
                        <p class="down-payment">Down Payment (50%): ₱<?php echo number_format($down_payment, 2); ?></p>
                        <p class="remaining-balance">Remaining Balance: ₱<?php echo number_format($remaining_balance, 2); ?></p>
                        <p class="final-payment-due">Final Payment Due (Before Shipping): ₱<?php echo number_format($final_payment_due, 2); ?></p>
                    </div>
